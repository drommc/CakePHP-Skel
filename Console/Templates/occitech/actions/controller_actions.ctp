 ...
 */
	public function <?php echo $admin; ?>delete($id = null) {
		...
		if ($this-><?php echo $currentModelName; ?>->delete()) {
			$flashMessage = __('<?php echo ucfirst(strtolower($singularHumanName)); ?> deleted');
		} else {
			$flashMessage = __('<?php echo ucfirst(strtolower($singularHumanName)); ?> was not deleted');
		}
<?php if ($wannaUseSession): ?>
		$this->Session->setFlash($flashMessage);
		$this->redirect(array('action' => 'index'));
<?php else: ?>
		$this->flash($flashMessage, array('action' => 'index'));
<?php endif; ?>
	}